        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteProducts = table.Column<string[]>(type: "text[]", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    MinimumStock = table.Column<decimal>(type: "numeric(18,3)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ValidityAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ValidityAlerts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ValidityAlerts_ProductId_ValidUntil",
                table: "ValidityAlerts",
                columns: new[] { "ProductId", "ValidUntil" },
                unique: true);
        }
